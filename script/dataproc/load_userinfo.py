...
spark = SparkSession.builder.appName("GCS-to-CloudSQL-UserInfo").getOrCreate()

# ✅ Cloud Storage and Cloud SQL details
GCS_BUCKET = "avito-landing-bucket-central1"
GCS_FILE = "UserInfo.csv"
...
def clean_data(df):
    ...
    required_columns = ["userid", "useragentid", "useragentosid", "userdeviceid", "useragentfamilyid"]
...
def write_to_mysql(df):
    try:
        ...
        insert_sql = """
        INSERT INTO UserInfo (UserID, UserAgentID, UserAgentOSID, UserDeviceID, UserAgentFamilyID, InsertedAt)
        VALUES (%s, %s, %s, %s, %s, %s)
        """
